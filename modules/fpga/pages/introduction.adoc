...
|===
| Tools                  | Version         | URL
| Vivado                 | 2025.1 or later | link:https://www.xilinx.com/support/download/index.html/content/xilinx/en/downloadNav/vivado-design-tools.html[Vivado (HW Developer)]
